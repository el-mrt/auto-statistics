#' Function that given a benchmark result, measure, task_type, task, number of learners, whether or not to build an ensemble learner and resampling strategy outputs a new benchmark, containing the best learners, as well an ensemble of those if specified.
#'
#' @param task task
...
#' @param ensemble include majority vote ensemble learner
